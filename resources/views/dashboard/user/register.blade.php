                    ...
                    <form action="{{ route('user.create') }}" method="post">
                        ...
                        <div class="form-group row">
                            <label for="classAssigned" class="col-md-4 col-form-label text-md-right">Assigned
                                Class</label>
                            <div class="col-md-6">
                                <input type="classAssigned" name="classAssigned" id="classAssigned" placeholder="Assigned Class"
                        ...
                        <div class="form-group row">
                            <label for="password_confirmation" class="col-md-4 col-form-label text-md-right">Confirm Password
                                </label>
                            <div class="col-md-6">
